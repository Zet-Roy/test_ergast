...
import { fetchDrivers, fetchMoreDrivers } from '../../store/actions/driversAcrion'
...
const ListDrivers = () => {
    ...
    const footerComponents = () => {
        return (
            drivers_data.list_drivers.length < drivers_data.total ? <ActivityIndicator size='large' color='#0000ff' /> : null
        )
    }
