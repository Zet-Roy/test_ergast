...
import { fetchRaces, fetchMoreRaces, clearRaces } from '../../store/actions/raceAction'
...
const RaceResult = ({ route }) => {
    ...
    const footerComponents = () => {
        return (
            races_data.list_race.length < races_data.total ? <ActivityIndicator size='large' color='#0000ff' /> : <View style={styles.footer} />
        )
    }
